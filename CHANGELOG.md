...
- Nothing on the Claude pet or pane path changes: the same six Claude rows, same names and states, were read by the installed 0.5.237 helper and this one against the live Mac.
