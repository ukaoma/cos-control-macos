...
single-session states. Blue saber; charcoal, navy, copper, and cream kit. The character is original and does not depict an existing actor.
...
| 3 | Contact. The blade strikes exactly one droid, with a blue impact burst. |
